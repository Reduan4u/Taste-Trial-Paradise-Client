...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-base-100 w-11/12 m-auto rounded-lg">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">© 2023 <strong>Taste Trial Paradise,</strong> All rights reserved.</div>
        </footer>
    );
};
