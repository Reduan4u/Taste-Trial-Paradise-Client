...
const Stats = () => {
    return (
        <div className="w-10/12 m-auto pb-10 text-black">

            <section className="p-6 my-6 bg-base-100 rounded-lg">
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-base-300  shadow-lg">
                    ...
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6   bg-base-300  shadow-lg     ">
                        ...
                        <div className="flex flex-col justify-center align-middle">
                            <p className="text-3xl font-semibold leadi">17500</p>
